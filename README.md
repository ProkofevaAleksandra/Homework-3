...
![1 3 2](https://user-images.githubusercontent.com/92428972/143219760-57cde09c-cfc1-4f0b-afb2-6491e760e20e.PNG)
       ...
       Добавлено два графика для сравнения скорости удаления элементов, так как при использовании одного графика значения MyLinkedList не заметны из-за того, что значения java.util.LinkedList намного больше. 
